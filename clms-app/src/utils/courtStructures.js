...
export const COURT_STRUCTURES = {
  vic: {
    ...
    showEmptyParts: true,
    defaultRegistry: 'Melbourne',
    divisions: ['Court of Appeal', 'Trial Division', 'Commercial Court'],
    parts: [
      { key: 'a', label: 'Part A', desc: 'Cases and legislation to be read from at a hearing' },
      { key: 'b', label: 'Part B', desc: 'Cases and legislation referred to but not to be read from at a hearing' },
  ...
  federal: {
    ...
    divisions: [],
    parts: [
      { key: '1', label: 'Part 1', desc: 'Authorities from which passages are to be read' },
      { key: '2', label: 'Part 2', desc: 'Authorities referred to but from which passages are not to be read' },
    ],
  },
  hca: {
    id: 'hca',
  ...
  nsw: {
    ...
    continuousNumbering: true,
    showEmptyParts: false,
    defaultRegistry: 'Sydney',
    divisions: ['Court of Appeal', 'Common Law Division', 'Equity Division'],
    parts: [
      { key: 'legislation', label: 'Legislation', desc: 'Legislation' },
      { key: 'cases-read', label: 'Cases to be Read', desc: 'Cases to be read' },
      { key: 'cases-referred', label: 'Cases Not Intended to be Read', desc: 'Cases not intended to be read' },
    ],
  },
  fcfcoa: {
    id: 'fcfcoa',
    ...
    parts: [
      { key: 'cases', label: 'Cases', desc: 'Cases' },
      { key: 'legislation', label: 'Legislation', desc: 'Legislation' },
    ],
  },
};
